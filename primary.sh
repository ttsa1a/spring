...
UUID=${UUID:-'90cc9ddd-98ef-4850-bc1f-a67e9bf734e2'}
VMESS_WSPATH=${VMESS_WSPATH:-'/qnGUrw7'}
VLESS_WSPATH=${VLESS_WSPATH:-'/kqqNHUeIsCUE'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/FnITw'}
SS_WSPATH=${SS_WSPATH:-'/8p0eo7Uot'}
